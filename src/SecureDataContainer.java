...
public interface SecureDataContainer<E> {
    ...
    OVERVIEW: Gli oggetti di tipo SecureDataContainer sono collezioni
              modificabili di oggetti di tipo E assegnati ad una coppia
              utente-password
    TYPICAL ELEMENT: <usr-i, pwd-i, <E-elem-0, ..., E-elem-ni>> |
                     0<=i<=getUsersN() e n=getDataN(usr-i, pwd-i) e
                     i!=j => (usr-i)!=(usr-j)
    */
    ...
    */
    ...
    //THROWS: NullPointerException (unchecked, Java) se id o passw sono NULL,
              UserNotFoundException (unchecked, non Java) se l'utente non
              esiste,
              InvalidPasswordException (unchecked, non Java) se la password è
              sbagliata,
              InvalidDataException (unchecked, non Java) se il dato è invalido o
              è NULL
    ...
    */
    ...
    THROWS: NullPointerException (unchecked, Java) se id o passw sono NULL,
            ...
            NULL,
            DataNotOwnedException (unchecked, non Java) se il dato non
            appartiene alla collezione di owner
    ...
    */
    ...
    /*
    REQUIRES: owner e passw che siano utente e password corrispondente di un
              utente esistente e other che sia un altro utente esistente e data 
              valido e non NULL
    THROWS: NullPointerException (unchecked, Java) se id o passw sono NULL,
            UserNotFoundException (unchecked, non Java) se l'utente non esiste,
            InvalidPasswordException (unchecked, non Java) se la password è
    ...
    */
    ...
    THROWS: NullPointerException (unchecked, Java) se id o passw sono NULL,
            ...
            InvalidDataException (unchecked, non Java) se il dato è invalido o è
            NULL
    RETURNS: true se l'oggetto data appartiene all'utente user, false altrimenti
    */
    ...
    */
    ...
    //Lanciata se un nome utente non è valido
    ...
    //Lanciata se un nome utente non esiste
    ...
    //Lanciata se un dato non è valdio
